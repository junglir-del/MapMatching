...
def main():
    ...
    ground_name = "dem_terrain" if dem else "bbox_ground"
    ground_feature = {
        "osm_type": "generated",
        "id": ground_name,
    ...
    if positions and indices:
        ...
        if dem:
            ...
            metadata["terrain_clipping"] = "exclude_buildings_roads_surface_areas"
    ...
    extras_doc = {
        ...
        "terrain_grid": args.terrain_grid if dem else None,
        "terrain_offset_m": args.terrain_offset if dem else None,
        "terrain_clipping": "exclude_buildings_roads_surface_areas" if dem else None,
