...
def main():
    ...
    metadata_doc = {
        ...
        "material_property_note": "source_tags contains the original OSM tags. osm_material is read directly from OSM material tags when present. inferred_material is the material used for dielectric_constant and conductivity_s_per_m; if no material can be identified, brick is used.",
