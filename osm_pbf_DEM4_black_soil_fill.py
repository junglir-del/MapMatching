...
def main():
    ...
    ground_name = "dem_soil_fill" if generate_soil_fill else "bbox_ground"
    ground_feature = {
        "osm_type": "generated",
        "id": ground_name,
    ...
    extras_doc = {
        ...
        "terrain_clipping": "none_unclipped_soil_fill" if generate_soil_fill else None,
        "soil_fill_strategy": "continuous_dem_soil_surface_under_osm_features" if generate_soil_fill else None,
        "height_rule": "soil uses DEM elevation; buildings, roads, water, grass, forest, and sand use the same DEM elevation baseline" if generate_soil_fill else None,
